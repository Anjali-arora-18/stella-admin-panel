...
export default {
  allUsers: (payload) =>
    `${apiBaseUrl}/users?page=${payload.page}&limit=${payload.limit}&sortKey=${payload.sortBy}&sortValue=${payload.sortOrder}&outletId=${payload.outletId}&search=${payload.search}`,
