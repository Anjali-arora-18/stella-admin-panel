<template>
    <VaModal v-model="showCheckoutModal" class="big-xl-modal" :mobile-fullscreen="false" size="large"
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        <div class="checkbox-group">
                                            <div class="checkbox checked" id="sameAddressCheckbox">✓</div>
                                            <label class="checkbox-label">Use same as
                                                delivery address</label>
                                        </div>
                                        <label class="form-label">Billing Address</label>
                                        <input type="text" class="form-input" id="billingAddress"
