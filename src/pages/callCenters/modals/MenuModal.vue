        ...
        <div class="grid grid-cols-1 sm:grid-cols-7">
            ...
            <div class="sm:col-span-2 bg-slate-100 p-4 sm:p-1 md:p-4">
                ...
                <div class="p-4 sm:p-1 md:p-4 text-center w-full mx-auto">
                    ...
                    <!-- Title -->
                    <h2 class="text-green-900 font-semibold text-lg uppercase">Sausage & Pepperoni</h2>

                    <!-- Description -->
                    <p class="text-gray-400 text-xs mt-1">
                        Pizza Sauce, Mozzarella Cheese, Italian Sausage, Pepperoni & Italian Seasoning
                    </p>

                    <!-- Tags -->
                    <div class="flex flex-wrap justify-center gap-1 mt-3 text-xs">
                        <span class="bg-pink-100 text-pink-600 px-2 py-1 rounded-full flex items-center gap-1">
                            🧀 Dairy
                        </span>
                        <span class="bg-pink-100 text-pink-700 px-2 py-1 rounded-full flex items-center gap-1">
                            🌾 Gluten
                        </span>
                        <span class="bg-pink-100 text-pink-700 px-2 py-1 rounded-full flex items-center gap-1">
                            🥚 Eggs
                    ...
                    <!-- Price -->
                    <div class="text-green-900 font-bold text-2xl mt-4">€22.99</div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label v-for="size in sizes" :key="size.label"
                            ...
                            <input type="radio" name="pizzaSize" :value="size.label" v-model="selectedSize"
                ...
                <div class="space-y-4 mt-5">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label v-for="size in sizes2" :key="size.label"
                            ...
                            <!-- Radio button positioned absolutely -->
                            <input type="radio" name="pizzaSize" :value="size.label" v-model="selectedCrust"
                                class="absolute bottom-2 right-2 accent-gray-700" />
                        </label>
                    </div>
                </div>
                <div class="space-y-4 mt-5">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label v-for="size in sizes3" :key="size.label"
                            ...
                            <!-- Radio button positioned absolutely -->
                            <input type="radio" name="pizzaSize" :value="size.label" v-model="selectedCheese"
                                class="absolute bottom-2 right-2 accent-gray-700" />
                        </label>
                    </div>
                </div>
                <div class="space-y-4 mt-5">
                    ...
                    <div class="flex flex-wrap gap-4">
                        <label v-for="size in sizes4" :key="size.label"
                            ...
                            <!-- Radio button positioned absolutely -->
                            <input type="radio" name="pizzaSize" :value="size.label" v-model="selectedSauce"
                                class="absolute bottom-2 right-2 accent-gray-700" />
                        </label>
                    </div>
                </div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <div v-for="topping in toppings" :key="topping.label"
                            ...
                            <div class="flex items-center gap-3 pr-12">
                                <img :src="topping.icon" alt="topping"
                                    :class="topping.quantity > 0 ? 'bg-white' : 'bg-[#f8f9fa]'"
                                class="w-10 h-10 object-cover rounded mr-4 p-2" />
                                <div class="text-left">
                                    <p class="font-semibold text-sm text-gray-800">{{ topping.label }}</p>
                                    <p class="text-sm text-gray-600 font-medium">€{{ topping.price }}</p>
                                </div>
                            </div>
                            ...
                            <div class="absolute bottom-2 right-2 flex items-center gap-1">
                                <button
                                    ...
                                    @click="decrement(topping)">-</button>
                                <span class="w-5 text-center text-sm">{{ topping.quantity }}</span>
                                <button
                                    class="w-6 h-6 text-sm font-bold border border-gray-300 rounded hover:bg-gray-100"
                                    @click="increment(topping)">+</button>
                            </div>
                        </div>
                    </div>
                </div>
