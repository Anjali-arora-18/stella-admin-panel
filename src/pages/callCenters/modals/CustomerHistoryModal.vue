...
<div class="flex items-center gap-1 ml-auto opacity-0 group-hover:opacity-100 transition mr-5">
  <span
    ...
    class="flex items-center gap-1 rounded-full text-black px-2 py-1.5 font-semibold text-xs cursor-pointer bg-gray-200 hover:bg-gray-300 transition-colors"
  ...
  <span
    size="small"
    class="flex items-center gap-1 rounded-full text-white px-2 py-1.5 font-semibold text-xs cursor-pointer bg-green-600 hover:bg-green-700 transition-colors"
  ...
  <span
    size="small"
    class="flex items-center gap-1 rounded-full text-white px-2 py-1.5 font-semibold text-xs cursor-pointer bg-red-600 hover:bg-red-700 transition-colors"
