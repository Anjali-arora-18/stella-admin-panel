        ...
        <form>
            ...
            <div class="bg-[#f8f9fa] px-4 py-6 w-full">
                ...
                <div class="flex flex-wrap sm:justify-end items-center gap-4">
                    ...
                    <!-- Cancel -->
                    <button type="button"
                        class="px-4 py-2 border border-gray-300 text-gray-600 rounded hover:bg-gray-100 text-sm font-medium">
                        Cancel
                    </button>

                    <!-- Save Customer -->
                    <button type="submit"
                        class="px-5 py-2 bg-green-800 text-white rounded hover:bg-green-900 text-sm font-semibold">
                        Save Customer
                    </button>
                </div>
            </div>
